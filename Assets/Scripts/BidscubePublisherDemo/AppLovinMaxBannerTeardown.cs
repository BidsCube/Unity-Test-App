...
/// <summary>No-op stubs when AppLovin MAX packages are not part of the active demo profile.</summary>
public static class AppLovinMaxBannerTeardown
{
    public const string PrefKeyBanner = "bidscube_testapp_max_ad_banner";
    ...
    public static string ResolveBannerAdUnitIdForTeardown() => null;
}
#endif
